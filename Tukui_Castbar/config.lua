...
ns.config={
	...
	player = {
		...
		["iconright"] = false, 						-- Display icon on right side of the bar.
		["fontsize"] = 12, 							-- Fontsize for spellname and cast time.
		["showticks"] = true, 						-- Display ticks on channeled spells.
	...
	target = { 
		...
		["noninterruptablecolor"] = {0.78, 0.25, 0.25, 0.5}, -- Color for noninterruptable spells. (not working yet)
	}
}